...
void create_file()
{
    ...
    fputs(temp1[9],file_heroes);
    fputs(temp2[9],file_heroines);
    fputs(temp3[9],file_directors);
    fputs(temp4[9],file_scores);
...
void main()
{
    ...
    char movie[25],hero[25],heroine[25],dir[25],dummy[25],w[20],p[100],q[100];
        ...
        for (i=0;i<n;i++)
        {
            op2=0.0,op3=0.0,op=0.0; //variable for demand score of movie
            if (i==0)
